	...
	public class GoodsListModule : RazorModuleWebControl
	{
		...
		public string GetDataJson()
		{
			...
			try
			{
				...
				string s = string.Format("GroupID={0}&GoodListSize={1}&FirstPriority={2}&SecondPriority={3}&ShowPrice={4}&Layout={5}&ShowIco={6}&ShowName={7}&ShowMaketPrice={8}", new object[]
				{
					this.GroupID,
					this.GoodListSize,
					this.FirstPriority,
