...
namespace Hidistro.Core.Entities
{
	...
	{
		public string DistributorCenterName
		{
			get;
			set;
		}
		...
		public string DistributionTeamName
		{
			get;
			set;
		}
        ...
        /// 站点后台管理员角色名
        /// </summary>
        public string SiteManagerRoleName
        {
            get;
            set;
        }

		public string FirstShopName
		{
			get;
			set;
		}

		public string SecondShopName
		{
			get;
			set;
		}

		public string MyCommissionName
		{
			get;
			set;
		}

		public string DistributionDescriptionName
		{
			get;
			set;
		}

		public string Exp_appKey
		{
			get;
			set;
		}

		public string Exp_appSecret
		{
			get;
			set;
		}

		public string Exp_apiUrl
		{
			get;
			set;
		}

		public string TelReg
		{
			get;
			set;
		}
		...
		public bool IsHomeShowFloatMenu
		{
			get;
			set;
		}
		...
		public bool IsShowDistributorSelfStoreName
		{
			get;
			set;
		}

		public bool IsDistributorBuyCanGetCommission
		{
			get;
			set;
		}

		public bool EnableMemberAutoToDistributor
		{
			get;
			set;
		}

		public bool EnabelBalanceWithdrawal
		{
			get;
			set;
		}

		public bool EnabeHomePageBottomLink
		{
			get;
			set;
		}

		public bool EnableHomePageBottomCopyright
		{
			get;
			set;
		}

		public string DistributionLinkName
		{
			get;
			set;
		}
		...
		public string CopyrightLinkName
		{
			get;
			set;
		}
		...
		public string MeiQiaEntId
		{
			get;
			set;
		}

		public bool IsShowSiteStoreCard
		{
			get;
			set;
		}

		public bool EnableBalancePayment
		{
			get;
			set;
		}

		public bool CommissionAutoToBalance
		{
			get;
			set;
		}

		public string CreatingStoreCardTips
		{
			get;
			set;
		}

		public string ToRegistDistributorTips
		{
			get;
			set;
		}
		...
		public decimal RechargeMoneyToDistributor
		{
			get;
			set;
		}
		...
		public void WriteToXml(XmlDocument doc)
		{
			...
			SiteSettings.SetNodeValue(doc, root, "MeiQiaEntId", this.MeiQiaEntId);
			SiteSettings.SetNodeValue(doc, root, "IsShowSiteStoreCard", this.IsShowSiteStoreCard ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "EnableBalancePayment", this.EnableBalancePayment ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "CommissionAutoToBalance", this.CommissionAutoToBalance ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "CreatingStoreCardTips", this.CreatingStoreCardTips);
			SiteSettings.SetNodeValue(doc, root, "ToRegistDistributorTips", this.ToRegistDistributorTips);
			...
			SiteSettings.SetNodeValue(doc, root, "RechargeMoneyToDistributor", this.RechargeMoneyToDistributor.ToString(CultureInfo.InvariantCulture));
			SiteSettings.SetNodeValue(doc, root, "PointsRate", this.PointsRate.ToString("F"));
			SiteSettings.SetNodeValue(doc, root, "ShoppingScoreUnit", this.ShoppingScoreUnit.ToString());
			...
			SiteSettings.SetNodeValue(doc, root, "EnabelBalanceWithdrawal", this.EnabelBalanceWithdrawal ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "EnabeHomePageBottomLink", this.EnabeHomePageBottomLink ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "EnableHomePageBottomCopyright", this.EnableHomePageBottomCopyright ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "DistributionLinkName", this.DistributionLinkName);
			SiteSettings.SetNodeValue(doc, root, "DistributionLink", this.DistributionLink);
			SiteSettings.SetNodeValue(doc, root, "AppKey", this.AppKey);
			SiteSettings.SetNodeValue(doc, root, "TelReg", this.TelReg);
			SiteSettings.SetNodeValue(doc, root, "CopyrightLinkName", this.CopyrightLinkName);
			SiteSettings.SetNodeValue(doc, root, "EnableMemberAutoToDistributor", this.EnableMemberAutoToDistributor ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "IsDistributorBuyCanGetCommission", this.IsDistributorBuyCanGetCommission ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "IsShowDistributorSelfStoreName", this.IsShowDistributorSelfStoreName ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "IsAutoGuide", this.IsAutoGuide ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "GuideConcernType", this.GuideConcernType.ToString(CultureInfo.InvariantCulture));
			SiteSettings.SetNodeValue(doc, root, "ConcernMsg", this.ConcernMsg);
			SiteSettings.SetNodeValue(doc, root, "IsMustConcern", this.IsMustConcern ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "IsHomeShowFloatMenu", this.IsHomeShowFloatMenu ? "true" : "false");
			SiteSettings.SetNodeValue(doc, root, "CopyrightLink", this.CopyrightLink);
			...
			SiteSettings.SetNodeValue(doc, root, "DistributorCenterName", this.DistributorCenterName);
			SiteSettings.SetNodeValue(doc, root, "CommissionName", this.CommissionName);
			SiteSettings.SetNodeValue(doc, root, "DistributionTeamName", this.DistributionTeamName);
			SiteSettings.SetNodeValue(doc, root, "MyShopName", this.MyShopName); 
            SiteSettings.SetNodeValue(doc, root, "SiteManagerRoleName", this.SiteManagerRoleName);
            SiteSettings.SetNodeValue(doc, root, "FirstShopName", this.FirstShopName);
			SiteSettings.SetNodeValue(doc, root, "SecondShopName", this.SecondShopName);
			SiteSettings.SetNodeValue(doc, root, "MyCommissionName", this.MyCommissionName);
			SiteSettings.SetNodeValue(doc, root, "DistributionDescriptionName", this.DistributionDescriptionName);
			SiteSettings.SetNodeValue(doc, root, "Exp_appKey", this.Exp_appKey);
			SiteSettings.SetNodeValue(doc, root, "Exp_appSecret", this.Exp_appSecret);
			SiteSettings.SetNodeValue(doc, root, "Exp_apiUrl", this.Exp_apiUrl);
		}
		...
		public static SiteSettings FromXml(XmlDocument doc)
		{
			...
			SiteSettings siteSettings = new SiteSettings(xmlNode.SelectSingleNode("SiteUrl").InnerText)
			{
				...
				MeiQiaEntId = xmlNode.SelectSingleNode("MeiQiaEntId").InnerText,
				IsShowSiteStoreCard = bool.Parse(xmlNode.SelectSingleNode("IsShowSiteStoreCard").InnerText),
				EnableBalancePayment = bool.Parse(xmlNode.SelectSingleNode("EnableBalancePayment").InnerText),
				CommissionAutoToBalance = bool.Parse(xmlNode.SelectSingleNode("CommissionAutoToBalance").InnerText),
				CreatingStoreCardTips = xmlNode.SelectSingleNode("CreatingStoreCardTips").InnerText,
				ToRegistDistributorTips = xmlNode.SelectSingleNode("ToRegistDistributorTips").InnerText,
				...
				RechargeMoneyToDistributor = decimal.Parse(xmlNode.SelectSingleNode("RechargeMoneyToDistributor").InnerText),
				PointsRate = decimal.Parse(xmlNode.SelectSingleNode("PointsRate").InnerText),
				ShoppingScoreUnit = Globals.ToNum(xmlNode.SelectSingleNode("ShoppingScoreUnit").InnerText),
				...
				EnabelBalanceWithdrawal = bool.Parse(xmlNode.SelectSingleNode("EnabelBalanceWithdrawal").InnerText),
				EnabeHomePageBottomLink = bool.Parse(xmlNode.SelectSingleNode("EnabeHomePageBottomLink").InnerText),
				EnableHomePageBottomCopyright = bool.Parse(xmlNode.SelectSingleNode("EnableHomePageBottomCopyright").InnerText),
				DistributionLinkName = xmlNode.SelectSingleNode("DistributionLinkName").InnerText,
				DistributionLink = xmlNode.SelectSingleNode("DistributionLink").InnerText,
				AppKey = xmlNode.SelectSingleNode("AppKey").InnerText,
				TelReg = xmlNode.SelectSingleNode("TelReg").InnerText,
				CopyrightLinkName = xmlNode.SelectSingleNode("CopyrightLinkName").InnerText,
				EnableMemberAutoToDistributor = bool.Parse(xmlNode.SelectSingleNode("EnableMemberAutoToDistributor").InnerText),
				IsDistributorBuyCanGetCommission = bool.Parse(xmlNode.SelectSingleNode("IsDistributorBuyCanGetCommission").InnerText),
				IsShowDistributorSelfStoreName = bool.Parse(xmlNode.SelectSingleNode("IsShowDistributorSelfStoreName").InnerText),
				IsAutoGuide = bool.Parse(xmlNode.SelectSingleNode("IsAutoGuide").InnerText),
				GuideConcernType = int.Parse(xmlNode.SelectSingleNode("GuideConcernType").InnerText),
				ConcernMsg = xmlNode.SelectSingleNode("ConcernMsg").InnerText,
				IsMustConcern = bool.Parse(xmlNode.SelectSingleNode("IsMustConcern").InnerText),
				IsHomeShowFloatMenu = bool.Parse(xmlNode.SelectSingleNode("IsHomeShowFloatMenu").InnerText),
				CopyrightLink = xmlNode.SelectSingleNode("CopyrightLink").InnerText,
				...
				DistributorCenterName = xmlNode.SelectSingleNode("DistributorCenterName ").InnerText,
				CommissionName = xmlNode.SelectSingleNode("CommissionName ").InnerText,
				DistributionTeamName = xmlNode.SelectSingleNode("DistributionTeamName ").InnerText,
				MyShopName = xmlNode.SelectSingleNode("MyShopName ").InnerText,
                SiteManagerRoleName = xmlNode.SelectSingleNode("SiteManagerRoleName")==null?"":xmlNode.SelectSingleNode("SiteManagerRoleName").InnerText,
                FirstShopName = xmlNode.SelectSingleNode("FirstShopName ").InnerText,
				SecondShopName = xmlNode.SelectSingleNode("SecondShopName ").InnerText,
				MyCommissionName = xmlNode.SelectSingleNode("MyCommissionName ").InnerText,
				DistributionDescriptionName = xmlNode.SelectSingleNode("DistributionDescriptionName ").InnerText,
				Exp_appKey = xmlNode.SelectSingleNode("Exp_appKey ").InnerText,
				Exp_appSecret = xmlNode.SelectSingleNode("Exp_appSecret ").InnerText,
				Exp_apiUrl = xmlNode.SelectSingleNode("Exp_apiUrl ").InnerText
			};
