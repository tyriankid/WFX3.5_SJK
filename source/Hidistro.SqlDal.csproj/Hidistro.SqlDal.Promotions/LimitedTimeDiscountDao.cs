...
namespace Hidistro.SqlDal.Promotions
{
	public class LimitedTimeDiscountDao
	{
		...
		public int AddLimitedTimeDiscount(LimitedTimeDiscountInfo info)
		{
			...
			this.database.AddInParameter(sqlStringCommand, "IsCommission", System.Data.DbType.Boolean, info.IsCommission);
			this.database.AddInParameter(sqlStringCommand, "CommissionDiscount", System.Data.DbType.Decimal, info.CommissionDiscount);
		...
		public bool UpdateLimitedTimeDiscount(LimitedTimeDiscountInfo info)
		{
			...
			if (flag)
			{
				System.Data.Common.DbCommand sqlStringCommand2 = this.database.GetSqlStringCommand("UPDATE  [Hishop_LimitedTimeDiscountProduct] SET  [BeginTime]=@BeginTime,[EndTime]=@EndTime   WHERE LimitedTimeDiscountId=@LimitedTimeDiscountId");
				this.database.AddInParameter(sqlStringCommand2, "BeginTime", System.Data.DbType.DateTime, info.BeginTime);
				this.database.AddInParameter(sqlStringCommand2, "EndTime", System.Data.DbType.DateTime, info.EndTime);
				this.database.AddInParameter(sqlStringCommand2, "LimitedTimeDiscountId", System.Data.DbType.Int32, info.LimitedTimeDiscountId);
		...
		public DbQueryResult GetDiscountProducted(ProductQuery query, int discountId)
		{
			...
			stringBuilder.AppendFormat(" AND SaleStatus <> ({0})", 2);
