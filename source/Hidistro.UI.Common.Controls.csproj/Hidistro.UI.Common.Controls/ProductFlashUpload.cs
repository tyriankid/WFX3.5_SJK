...
namespace Hidistro.UI.Common.Controls
{
	public class ProductFlashUpload : WebControl
	{
		...
		private void DoDelete(string originalPath)
		{
			...
			{
				string a = Path.GetExtension(originalPath).ToLower();
				if (a == ".gif" || a == ".jpg" || a == ".png" || a == ".jpeg")
				{
					string path = originalPath.Replace("\\images\\", "\\thumbs40\\40_");
					originalPath.Replace("\\images\\", "\\thumbs60\\60_");
					string path2 = originalPath.Replace("\\images\\", "\\thumbs100\\100_");
					string path3 = originalPath.Replace("\\images\\", "\\thumbs160\\160_");
					string path4 = originalPath.Replace("\\images\\", "\\thumbs180\\180_");
					string path5 = originalPath.Replace("\\images\\", "\\thumbs220\\220_");
					string path6 = originalPath.Replace("\\images\\", "\\thumbs310\\310_");
					string path7 = originalPath.Replace("\\images\\", "\\thumbs410\\410_");
