	...
	public class UploadHandler : IHttpHandler
	{
		...
		private void DoDelete(HttpContext context)
		{
			...
			if (a == ".gif" || a == ".jpg" || a == ".png" || a == ".jpeg")
			{
				...
				text.Replace("\\images\\", "\\thumbs60\\60_");
				string path2 = text.Replace("\\images\\", "\\thumbs100\\100_");
				string path3 = text.Replace("\\images\\", "\\thumbs160\\160_");
				string path4 = text.Replace("\\images\\", "\\thumbs180\\180_");
				string path5 = text.Replace("\\images\\", "\\thumbs220\\220_");
				string path6 = text.Replace("\\images\\", "\\thumbs310\\310_");
				string path7 = text.Replace("\\images\\", "\\thumbs410\\410_");
				if (File.Exists(text))
				{
					File.Delete(text);
				}
