...
namespace Hidistro.UI.Web.Admin.Fenxiao
{
	public class DistributorList : AdminPage
	{
		...
		protected System.Web.UI.WebControls.HiddenField hdVery;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
				string value = System.DateTime.Now.ToString("yyyyMMddHHmmss");
				this.hdVery.Value = value;
				this.Session["modifyCommissionVeryCode"] = value;
			}
			if (!string.IsNullOrEmpty(text))
			{
				...
				if (text == "readinfo")
				{
					...
					if (int.TryParse(this.Page.Request.QueryString["UserId"], out num))
					{
						...
						{
							System.Data.DataTable value2 = new System.Data.DataTable();
							value2 = (System.Data.DataTable)distributors.Data;
							s = "{error:0,Data:" + JsonConvert.SerializeObject(value2) + "}";
						}
						else
						{
		...
		private void BindData()
		{
			...
			distributorsQuery.UserName = this.UserName;
