	...
	public class DistributorStatisticsDetails : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (distributorSaleinfo != null && distributorSaleinfo.Rows.Count > 0)
			{
				...
				decimal num2 = decimal.Parse(distributorSaleinfo.Rows[0]["BuyUserIds"].ToString());
				this.BuyPrice.InnerText = ((num2 > 0m) ? (decimal.Parse(distributorSaleinfo.Rows[0]["OrderTotalSum"].ToString()) / num2).ToString("F2") : "0.00");
			}
