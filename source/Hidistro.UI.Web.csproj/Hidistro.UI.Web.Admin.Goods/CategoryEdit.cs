...
namespace Hidistro.UI.Web.Admin.Goods
{
	...
	public class CategoryEdit : AdminPage
	{
        ...
        protected TextBox txtDelayDays;
		...
		private void BindCategoryInfo(CategoryInfo categoryInfo)
		{
			if (categoryInfo != null)
			{
                ...
                this.txtDelayDays.Text = categoryInfo.DelayDays.ToString();
		...
		private CategoryInfo GetCategory()
		{
            ...
            categoryInfo.DelayDays = Convert.ToInt32(this.txtDelayDays.Text.Trim());
			categoryInfo.Notes1 = "";
			categoryInfo.Notes2 = "";
			categoryInfo.Notes3 = "";
