...
namespace Hidistro.UI.Web.Admin.Shop
{
    public class DistributorDetails : AdminPage
    {
        ...
        protected DistributorDetails() : base("m05", "fxp13")
        {
        }
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            this.userid = ManagerHelper.GetCurrentManager().SiteId;
        ...
        private void BtnSavePicture_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (ManagerHelper.GetCurrentManager() != null && ucFlashUpload1.Value != "")
                {
                    DistributorsInfo entity = new DistributorsInfo();
                    entity.UserId = Convert.ToInt32(ManagerHelper.GetCurrentManager().SiteId);
                    ...
                    if (DistributorsBrower.EditDisbutosBannerURL(entity))
                    {
                        ...
                        Response.Redirect("DistributorDetails.aspx");
                    }
