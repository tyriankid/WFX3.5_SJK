	...
	public class Hi_Ajax_GetItems : System.Web.IHttpHandler
	{
		...
		public string GetGoodsListJson(DbQueryResult GoodsTable)
		{
			...
			for (int i = 0; i < dataTable.Rows.Count; i++)
			{
				...
				stringBuilder.Append("\"price\":\"" + System.Convert.ToDecimal(dataTable.Rows[i]["SalePrice"]).ToString("f2") + "\",");
				stringBuilder.Append("\"original_price\":\"" + System.Convert.ToDecimal(dataTable.Rows[i]["MarketPrice"]).ToString("f2") + "\",");
