...
namespace Hidistro.UI.Web.Admin.Shop
{
	public class Hi_Ajax_GoodsListGroup : System.Web.IHttpHandler
	{
		...
		public string GoodGroupJson(System.Web.HttpContext context)
		{
			...
			hi_Json_GoodGourpContent.showMaketPrice = (context.Request.Form["ShowMaketPrice"] == null || System.Convert.ToBoolean(context.Request.Form["ShowMaketPrice"]));
			hi_Json_GoodGourpContent.secondPriority = ((Globals.RequestFormStr("SecondPriority").Trim() != "") ? System.Convert.ToInt32(context.Request.Form["SecondPriority"]) : 3);
