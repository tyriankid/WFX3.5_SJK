	...
	public class ExpressTemplates : AdminPage
	{
		...
		private void DeleteXmlFile(string xmlfile)
		{
			...
			if (System.IO.File.Exists(text))
			{
				...
				string savePath = System.Web.HttpContext.Current.Request.MapPath(Globals.ApplicationPath + string.Format("/Storage/master/flex/{0}", xmlNode.InnerText));
				Globals.DelImgByFilePath(savePath);
