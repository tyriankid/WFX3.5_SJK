...
namespace Hidistro.UI.Web.Admin.Trade
{
	public class ManageOrder : AdminPage
	{
        ...
        protected System.Web.UI.HtmlControls.HtmlGenericControl spancountinfo;
		...
		protected System.Web.UI.WebControls.TextBox txtShipId;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else if (a == "GetOrdersStates")
			{
				base.Response.ContentType = "application/json";
                    ...
                    System.Data.DataTable allOrderID = OrderHelper.GetAllOrderID(ManagerHelper.GetCurrentManager().SiteId);
		...
		private void BindOrders()
		{
         ...
         string countinfo= OrderHelper.GetOrderCountInfo(orderQuery);
            spancountinfo.InnerHtml = "统计信息：当前结果集 共有<span style=' font-weight:bolder';>" + orders.TotalRecords + "</span>个订单 其中<span style='font-weight:bolder';>" + countinfo .Split(',')[0]+ "</span>个订单已付款,已付款金额累计<span style='color: green; font-weight:bolder';> " +   countinfo.Split(',')[1] + "</span>元";
		...
		private OrderQuery GetOrderQuery()
		{
            ...
            if (ManagerHelper.GetCurrentManager().SiteId >0)
            {
                orderQuery.ReferralUserId = ManagerHelper.GetCurrentManager().SiteId;
                txtShopName.Text = VShopHelper.GetUserIdDistributors(ManagerHelper.GetCurrentManager().SiteId).StoreName;
            }
			...
			{
				orderQuery.ShipId = Globals.UrlDecode(this.Page.Request.QueryString["ShipId"]);
			}
		...
		private void ReloadOrders(bool isSearch)
		{
			...
			nameValueCollection.Add("ShipId", this.txtShipId.Text);
		...
		protected void btnExport_Click(object sender, System.EventArgs e)
		{
			...
			string s = OrderHelper.ExportOrderData(text);
			base.Response.ClearContent();
			this.Page.Response.Buffer = false;
			base.Response.ContentEncoding = System.Text.Encoding.UTF8;
			base.Response.AddHeader("content-disposition", "attatchment;filename=" + System.Web.HttpUtility.UrlEncode("data_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls", System.Text.Encoding.UTF8));
			base.Response.ContentType = "application/ms-excel";
			base.Response.Write(s);
			base.Response.End();
		}
