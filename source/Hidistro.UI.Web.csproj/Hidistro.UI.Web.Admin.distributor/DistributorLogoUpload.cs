		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if (num < 1)
				{
					...
					if (text == ".gif" || text == ".jpg" || text == ".png" || text == ".jpeg")
					{
						string text2 = str + text;
						string text3 = Globals.UploadFileAndCheck(httpPostedFile, Globals.MapPath(str2 + text2));
						if (text3 == "1")
						{
							try
							{
								System.Drawing.Bitmap bitmap = new System.Drawing.Bitmap(Globals.MapPath(str2 + text2));
							...
							base.Response.Write(str + "|/Storage/data/DistributorLogoPic/" + text2);
							SiteSettings masterSettings = SettingsManager.GetMasterSettings(false);
							string path = masterSettings.DistributorLogoPic;
							path = base.Server.MapPath(path);
							masterSettings.DistributorLogoPic = "/Storage/data/DistributorLogoPic/" + text2;
