	...
	public class EditGameGuaGuaLe : AdminPage
	{
		...
		private void BindDate()
		{
			...
			if (modelByGameId != null)
			{
				...
				GamePrizeInfo gamePrizeInfo = gamePrizeListsByGameId.FirstOrDefault((GamePrizeInfo p) => p.PrizeGrade == PrizeGrade.一等奖);
				if (gamePrizeInfo != null)
				{
					this.lbPrizeGade0.Text = "一等奖：" + gamePrizeInfo.PrizeType.ToString();
				}
				gamePrizeInfo = gamePrizeListsByGameId.FirstOrDefault((GamePrizeInfo p) => p.PrizeGrade == PrizeGrade.二等奖);
				if (gamePrizeInfo != null)
				{
					this.lbPrizeGade1.Text = "二等奖：" + gamePrizeInfo.PrizeType.ToString();
				}
				gamePrizeInfo = gamePrizeListsByGameId.FirstOrDefault((GamePrizeInfo p) => p.PrizeGrade == PrizeGrade.三等奖);
				if (gamePrizeInfo != null)
				{
					this.lbPrizeGade2.Text = "三等奖：" + gamePrizeInfo.PrizeType.ToString();
				}
				gamePrizeInfo = gamePrizeListsByGameId.FirstOrDefault((GamePrizeInfo p) => p.PrizeGrade == PrizeGrade.四等奖);
				if (gamePrizeInfo != null)
				{
					this.lbPrizeGade3.Text = "四等奖：" + gamePrizeInfo.PrizeType.ToString();
				}
