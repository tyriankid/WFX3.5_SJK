                ...
                <div class="data-shop">
                    <div class="datashop-top">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="javascript:void(0)">平台实时数据</a></li>
                        </ul>
                    </div>
                    <div class="data-list clearfix">
                        ...
                        <div class="shopnumber-list fl">
                            <ul>
                                ...
                                <li class="noborder"><span>服务站点数：</span><a href="Fenxiao/distributorlist.aspx"><%=DistributorQty %></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="shopdatatable clearfix">
                    <div class="shopdatatable-left fl">
                        <table class="table table-hover">
                            <caption>服务站点销售额排名<p><span class="active">近7天</span><%--<span>30天</span>--%></p></caption>
                            <thead>
                                <tr>
                                    <th>店铺名称</th>
                                    <th>销售订单数</th>
