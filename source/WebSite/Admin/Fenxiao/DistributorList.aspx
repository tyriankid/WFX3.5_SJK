...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function bindManager(userid) {
            DialogFrame("../Settings/AddSiteManager.aspx?siteid=" + userid, "创建后台账号", 680, 410, function () { location.href = "<%=localUrl%>"; });
        }
            ...
            <div class="table-page">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#home">
                        <asp:Literal ID="ListActive" Text="站点列表(10)" runat="server"></asp:Literal></a></li>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%">后台账号</th>
                                        <th width="10%" style="text-align: left">站点名/联系人</th>
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="mb10 table-operation">
                                                ...
                                                <asp:Button ID="FrozenCheck" runat="server" Text="批量冻结" CssClass="btn resetSize btn-primary" IsShow="true" OnClientClick="return HiConform('<strong>冻结后服务站不能进入管理中心，期间也不会有新的订单产生。</strong><p>确定要冻结该服务站点吗？</p>', this);" />
                                                ...
                                                <asp:Button ID="CancleCheck" Visible="false" runat="server" Text="取消分销资质" CssClass="btn resetSize btn-primary" IsShow="true" OnClientClick="return HiConform('<strong class=red>取消服务站点以后不可恢复也不能重新申请。</strong><p>是否继续？</p>', this);" />
                                                &nbsp;&nbsp;
                            ...
                            <table class="table">
                                <tbody>
                                    <asp:Repeater ID="reDistributor" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td width="15%"><%# Eval("ManagerName").ToString()==""?"<a href=\"javascript:bindManager("+Eval("UserId")+")\">创建后台管理账号</a>":Eval("ManagerName").ToString()%></td>
                                    ...
                                    DeleteMsg="确定要冻结分销商？" title="冻结以后，分销商不能进入分销管理中心，期间也不会获得佣金。" />--%>
                                                        <asp:Button ID="btnFrozen" CommandName="Frozen" CommandArgument='<%# Eval("UserId")%>' class="btnLink pad" runat="server" Text="冻结" IsShow="true" OnClientClick="return HiConform('<strong>冻结后服务站不能进入管理中心，期间也不会有新的订单产生。</strong><p>确定要冻结该服务站点吗？</p>', this);" />
                                                    </p>
                                    ...
                                    DeleteMsg="取消分销商资质以后不可恢复也不能重新申请，是否继续？" />--%>
                                                        <asp:Button ID="ImageLinkButton1" Visible="false" CommandName="Forbidden" CommandArgument='<%# Eval("UserId")%>' runat="server" Text="取消服务站点" class="btnLink pad" IsShow="true" OnClientClick="return HiConform('<strong>取消服务站点以后不可恢复也不能重新申请。</strong><p>是否继续？</p>', this);" />
