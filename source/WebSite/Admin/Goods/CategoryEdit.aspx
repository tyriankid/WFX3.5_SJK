    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#aspnetForm').formvalidation({
                ...
                'ctl00$ContentPlaceHolder1$txtDelayDays': {
                    validators: {
                        notEmpty: {
                            message: '延迟配送天数不能为空'
                        },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="aspnetForm" runat="server" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control inputw200" MaxLength="60" />
                    ...
                    <div class="form-group" style="display:<%=categoryid>0?"none":"none"%>">
                    ...
                    <div class="form-group" style="display:none">
                        <label class="col-xs-2 control-label">牛奶类型</label>
                        <div class="col-xs-6">
                           <Hi:ProductTypeDownList runat="server"  ID="dropProductTypes" CssClass="form-control inputw200" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-2 control-label"><em>*</em>延迟配送天数</label>
                        <div class="col-xs-6">
                            <asp:TextBox ID="txtDelayDays" runat="server" CssClass="form-control inputw200" MaxLength="5" />
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="exitshopinfo resize bg" style="display:<%=(categoryid>0||dropCategories.SelectedValue>0)?"none":"none"%>">
                        <div class="form-horizontal">
                            <h3 class="resize">分销佣金设置</h3>
                            <div class="form-group">
                                <label for="input6" class="col-xs-2 control-label"><em><%--*--%></em>上二级佣金比例：</label>
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtthird"  runat="server" CssClass="form-control" MaxLength="5" Text="0" />&nbsp;&nbsp;%
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input7" class="col-xs-2 control-label"><em><%--*--%></em>上一级佣金比例：</label>
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtsecond" runat="server" CssClass="form-control" MaxLength="5" Text="0"/>&nbsp;&nbsp;%
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input8" class="col-xs-2 control-label"><em><%--*--%></em>成交店铺佣金比例：</label>
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtfirst" runat="server" CssClass="form-control" MaxLength="5" Text="0"/>&nbsp;&nbsp;%
                                </div>
                            </div>
                        </div>
       </div>
