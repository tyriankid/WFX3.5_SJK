...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
        ...
        <div class="clearfix">
            <div class="fl">
                <a href="categoryedit.aspx" class="btn btn-primary btn-sm">添加牛奶分类<span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <span class="Name icon Pg_10" style="display:none"><a href="javascript:ShowRemoveProduct(<%#Eval("CategoryId") %>)">转移商品</a></span> <span class="submit_bianji">
                            ...
                            <span class="Name icon Pg_10"  style="display:none">
