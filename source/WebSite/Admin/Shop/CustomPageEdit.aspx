                    ...
                    <div class="diy clearfix">
                        ...
                        <div id="diy-ctrl">
                            <div class="diy-ctrl-item" data-origin="pagetitle" style="margin-top: 85px;">
                                ...
                                <div class="formitems">
                                    <label class="fi-name">使用首页模块：</label>
                                    <div class="form-controls">
                                        <div class="checkbox-group bl mb10">
                                            <label>
                                                <input type="checkbox" id="j-isshowmenu" <%=  model.Status ==0? (model.IsShowMenu==true?"checked":""): (model.DraftIsShowMenu==true?"checked":"") %> name="showBomMenu">底部店铺导航</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="formitems">
