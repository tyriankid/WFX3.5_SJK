...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                  ...
                  <%--  <li id="liOper2">
                    ...
                    <li id="liOper5">
                        <asp:HyperLink ID="hlinkTradeFinished" runat="server"><span>已付款</span></asp:HyperLink></li>
                    <li id="liOper4">
         ...
         <span id="spancountinfo" runat="server">统计信息：当前结果集 共有30个订单 其中28个订单已付款,已付款金额累计20000元</span>   
         </div>
                    ...
                    <div class="form-horizontal fl">
                        <div class="form-group mar forced">
                            ...
                            <asp:Button ID="btnExport" runat="server" Text="导出Excel" CssClass="btn btn-primary resetSize" OnClick="btnExport_Click" OnClientClick="return checkExport()" />
                                <a style="display:none;" href="<%=Globals.GetErpLink() %>" target="_blank" class="btn btn-info resetSize">批量打印电子面单</a>
                                                    ...
                                                    <asp:Repeater ID="rptSubList" runat="server" OnItemDataBound="rptSubList_ItemDataBound">
                                                        <ItemTemplate>
                                                            <div class="orderInfolist clearfix">
                                                                ...
                                                                <br/>
                                                                <p style="margin-top:20px">配送时间段： <%# Eval("SendStartDate").ToString().Replace(" 0:00:00","").Replace("/","-") %>至<%# Eval("SendEndDate").ToString().Replace(" 0:00:00","").Replace("/","-") %><p>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                </div>
                    ...
                    if (json.type == "1") {
                        if (json.allcount > 0) {
                            ...
                            if (json.finishedcount > 0) {
                                ...
                                $("#liOper5").find("span").html($("#liOper5").find("span").html() + "(" + (json.finishedcount + json.buyalreadypaidcount + json.sellalreadysentcount) + ")"); //零时修改
                            }
